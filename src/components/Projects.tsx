...
const Projects: React.FC = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "A pixel-perfect clone of Google's homepage built with HTML, CSS, and JavaScript. Features responsive design, search functionality, and authentic styling that matches Google's interface.",
      technologies: ["HTML", "CSS", "JavaScript", "Responsive Design"],
      githubUrl: "https://github.com/devika-viswanath/Google-Homepage-Clone",
      image: "https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png",
      details: [
        "Recreated Google's homepage with pixel-perfect accuracy",
        "Implemented responsive design for mobile and desktop views",
        "Added functional search bar with Google search integration",
        "Styled with CSS to match Google's color scheme and typography",
        "Included interactive elements like hover effects and animations",
