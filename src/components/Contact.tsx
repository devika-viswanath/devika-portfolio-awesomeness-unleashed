          ...
          <div className="order-1 md:order-2">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">devikaviswanath135@gmail.com</p>
                  </div>
                </div>
            ...
            <div className="glossy-card rounded-xl p-6 shadow-lg">
              ...
              <div className="flex space-x-4">
                <a 
                  href="https://x.com/DevikaB116528" 
                  target="_blank"
                ...
                <a 
                  href="https://www.linkedin.com/in/devikab-mca/"
                  target="_blank"
                  rel="noopener noreferrer" 
                ...
                <a 
                  href="https://github.com/devika-viswanath"
                  target="_blank"
                  rel="noopener noreferrer" 
                ...
                <a 
                  href="mailto:devikaviswanath135@gmail.com"
                  className="w-12 h-12 rounded-full bg-[#E4405F]/10 flex items-center justify-center hover:bg-[#E4405F]/20 transition-colors"
                  aria-label="Email"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#E4405F]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                </a>
              </div>
